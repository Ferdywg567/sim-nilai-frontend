...
<template>
  <div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" v-show="isAuthenticated != null && isAuthenticated">
        {{isAuthenticated}}
      ...
      <div class="layout-page">
        ...
        <nav
          ...
          id="layout-navbar" v-show="isAuthenticated != null && isAuthenticated">
        ...
        <div class="content-wrapper">
          ...
          <!-- Footer -->
          <footer class="content-footer footer bg-footer-theme" v-show="isAuthenticated != null && isAuthenticated">
